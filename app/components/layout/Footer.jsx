    ...
    <div className="border-t border-neutral-800/50 bg-white/5 py-4 flex flex-col items-stretch justify-start">
      ...
      >
        <p className="text-sm text-center">
          ...
          <Anchor href="mailto:thisisazeez0@gmail.com">
        ...
        {/* <div className="flex flex-row items-center justify-center flex-wrap gap-4">
          <Anchor
            styled={false}
            href="https://www.producthunt.com/posts/JobConnect?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-JobConnect"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=345426&theme=dark"
              alt="JobConnect - The&#0032;only&#0032;job&#0032;board&#0032;you&#0032;will&#0032;ever&#0032;need&#0046; | Product Hunt"
              width={96}
              height={22}
            />
          </Anchor>
